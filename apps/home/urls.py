...
urlpatterns = [
    ...
    path(
        "weather_station_past",
        views.WeatherStationPastView.as_view(),
        name="weather_station_past",
    ),
    ...
    path(
        "mydata_weatherstation",
        views.mydata_weatherstation,
        name="mydata_weatherstation",
    ),
    path(
        "api/weather_station",
        views.WeatherStationAPI.as_view(),
    ...
    path(
        "api/delete/water_pump/",
        views.DeleteWaterPump.as_view(),
        name="delete-water_pump_api",
    ),
    path(
        "api/delete/water_tank/",
        views.DeleteWaterTank.as_view(),
        name="delete-water_tank_api",
    ),
    path(
        "api/delete/weather_station/",
        views.DeleteWeatherstation.as_view(),
        name="delete-weather_station_api",
    ),
    path(
        "api/delete/offline_scenario/",
        views.DeleteOfflineScenario.as_view(),
        name="delete-offline_scenario_api",
    ),
    path(
        "watertank-operation/",
        views.WaterTankOperation.as_view(),
        name="watertank-operation",
    ),
    ...
    path(
        ...
        views.WeatherStationOperation.as_view(),
        name="WeatherStation-operation",
    ),
    path("tree-operation/", views.TreeOperation.as_view(), name="tree-operation"),
    path(
        "waterpump-operation/",
        views.WaterPumpOperation.as_view(),
        name="waterpump-operation",
    ),
    path(
        "offlinescenario-operation/",
        views.OfflineScenarioOperation.as_view(),
        name="offlinescenario-operation",
    ),
