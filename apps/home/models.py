...
class Result(models.Model):
    ...
    watershare = models.ForeignKey(WaterShare, on_delete=models.CASCADE, blank=True, null=True, related_name="number_results")
...
# def __str__(self):
#   return "%s %sTree" % (self.packet, self.location)
